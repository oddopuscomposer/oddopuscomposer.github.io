...
cover: assets/img/book_covers/CodexSeraphinianus.jpg
olid:  # use Open Library ID to fetch cover (if no `cover` is provided)
isbn:  # use ISBN to fetch cover (if no `olid` is provided, dashes are optional)
categories: conlang world-building
tags: semiotics
buy_link: 
started: 2026-02
finished: 2026-02
...
“I must confess the true author of the Codex the white cat, and not I, even though I have always passed myself off as being the author, whereas I was merely its manual executer” - while working on the encyclopaedic work and living off pizza he met a white cat in the alleyway who followed him home and slept on his shoulders as he worked. Liking it to Ruslan and Lyudmila poem, instead of the cat telling a story or singing a song, the cat quietly permeated these works, he mused.
 ”As dusk fell, pigeons would land on the peeling parapet to feast on the bread crumbs I offered them in abundance. In return, I received the news of the day through the cooing sounds and flapping of the wings that I managed to understand thanks to the teachings of my grandmother, who was Umbrian and familiar with their language.”
 
 - if only I could construct such a pigin bridge to the language of pigeons (or crows), imagine all the insight… and gossip.
