...
<span style="display: block; float: right; clear: right; margin-right: -42%; width: 35%; font-size: 0.8em; line-height: 1.4; color: #666;"> A modern computer AES-256 encryption would require billions of years to brute force, not to mention exceptional amount of power required and many replications of the strongest computers currently made. - But if you know the key its easy. Also apparently, quantum computers might be bit of a game changer.</span>
...
<div class="row mt-2">
    <div class="col-sm mt-2 mt-md-0">
    So lots of cool avenues to explore.<br>But that's a ramble for another day.<br>
